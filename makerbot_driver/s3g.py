...
class s3g(object):
  ...
  def build_start_notification(self, build_name):
    ...
    if len(build_name) > makerbot_driver.maximum_payload_length - other_info_in_packet:
      build_name = build_name[:makerbot_driver.maximum_payload_length-other_info_in_packet]
    payload = struct.pack(
      '<BI',
      makerbot_driver.host_action_command_dict['BUILD_START_NOTIFICATION'],
      0
    )
  ...
  def get_toolhead_version(self, tool_index):
    ...
    response = self.tool_query(tool_index,makerbot_driver.slave_query_command_dict['GET_VERSION'], payload)
    [response_code, version] = makerbot_driver.Encoder.unpack_response('<BH', response)
  ...
  def get_PID_state(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_PID_STATE'])
  ...
  def get_tool_status(self, tool_index):
   ...
   """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_TOOL_STATUS'])
  ...
  def toolhead_abort(self, tool_index):
    ...
    """
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['ABORT'])
  ...
  def toggle_motor1(self, tool_index, toggle, direction):
    ...
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['TOGGLE_MOTOR_1'], payload)
  ...
  def get_toolhead_temperature(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_TOOLHEAD_TEMP'])
  ...
  def is_tool_ready(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['IS_TOOL_READY'])
  ...
  def read_from_toolhead_EEPROM(self, tool_index, offset, length):
    ...
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['READ_FROM_EEPROM'], payload)
  ...
  def write_to_toolhead_EEPROM(self, tool_index, offset, data):
    ...
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['WRITE_TO_EEPROM'], payload)
  ...
  def get_platform_temperature(self, tool_index):
    ...
    @return int temperature: reported by the toolhead
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_PLATFORM_TEMP'])
    [response_code, temperature] = makerbot_driver.Encoder.unpack_response('<BH', response)
  ...
  def get_toolhead_target_temperature(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_TOOLHEAD_TARGET_TEMP'])
    [response_code, temperature] = makerbot_driver.Encoder.unpack_response('<BH', response)
  ...
  def get_platform_target_temperature(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['GET_PLATFORM_TARGET_TEMP'])
    [response_code, temperature] = makerbot_driver.Encoder.unpack_response('<BH', response)
  ...
  def is_platform_ready(self, tool_index):
    ...
    """
    response = self.tool_query(tool_index, makerbot_driver.slave_query_command_dict['IS_PLATFORM_READY'])
    [response_code, ready] = makerbot_driver.Encoder.unpack_response('<BB', response)
  ...
  def toggle_fan(self, tool_index, state):
    ...
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['TOGGLE_FAN'], payload)
  ...
  def toggle_extra_output(self, tool_index, state):
    ...
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['TOGGLE_EXTRA_OUTPUT'], payload)
  ...
  def toolhead_init(self, tool_index):
    ...
    """
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['INIT'])
  ...
  def set_toolhead_temperature(self, tool_index, temperature):
    ...
    self.tool_action_command(tool_index, makerbot_driver.slave_action_command_dict['SET_TOOLHEAD_TARGET_TEMP'], payload)
