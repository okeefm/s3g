...
class TestGcodeAssembler(unittest.TestCase):
  ...
  def test_assemble_gcode_dualstrusion_pla(self):
    ...
    got_start, got_end, got_variables = self.ga.assemble_recipe(tool_0=True, tool_1=True, material='PLA')
  ...
  def test_assemble_gcode_tool_0_pla(self):
    ...
    got_start, got_end, got_variables = self.ga.assemble_recipe(material='PLA')
    for expect, got in zip([expected_start_template, expected_end_template, expected_variables], [got_start, got_end,got_variables]):
      self.assertEqual(expect, got)
  ...
  def test_assemble_gcode_tool_1_pla(self):
    ...
    got_start, got_end, got_variables = self.ga.assemble_recipe(tool_0=False, tool_1=True, material='PLA')
    for expect, got in zip([expected_start_template, expected_end_template, expected_variables], [got_start, got_end,got_variables]):
      self.assertEqual(expect, got)
  ...
  def test_assemble_gcode_dualstrusion_abs(self):
    ...
    got_start, got_end, got_variables = self.ga.assemble_recipe(tool_1=True, material='ABS')
    for expect, got in zip([expected_start_template, expected_end_template, expected_variables], [got_start, got_end,got_variables]):
      self.assertEqual(expect, got)
