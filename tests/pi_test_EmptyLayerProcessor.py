...
class TestEmptyLayerProcessor(unittest.TestCase):
    ...
    def test_process_gcode(self):
        ...
        cases = [
            ...
            [
                ["(<layer> 0.305 )\n",
                 "G1 X-0.33 Y-6.87 Z0.14 F1068.781 E5.091\n",
                 "G1 X-0.98 Y-6.8 Z0.14 F1068.781 E5.123\n",
                 "G1 X-1.62 Y-6.68 Z0.14 F1068.781 E5.155\n",
                 "G1 X-3.99 Y-5.6 Z0.14 F1068.781 E5.283\n",
                 "G1 X-4.5 Y-5.19 Z0.14 F1068.781 E5.315\n",
                 "G1 X-4.97 Y-4.75 Z0.14 F1068.781 E5.347\n",
                 "G1 F1200.0\n",
                 "G1 E4.347\n",
                 "G1 F1068.781\n",
                 "(</edge>)\n",
        ...
        cases = [
            ...
            (
                ["M135 T0\n",
                 "G1 X-10.352 Y-9.396 Z0.27\n",
                 "G1 Z0.270 F1380.000 (move Z)\n",
                 "G1 X-8.907 Y-12.833 Z0.540 F4800.000 A112.733\n",
                 "(</layer>)\n",
                ],
                False
            ),
